...
const Login = () => {
  ...
  return (
    <div className="bg-[#212121] w-full min-h-screen flex flex-col justify-center items-center">
      <Toaster />
      <div
        style={{
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center text-white text-semibold text-xl">
          <div className="flex px-2 w-full shadow-2xl flex-col  mt-4 mb-4">
            {/* <label htmlFor="username">username</label>
              <input
                
                
                className="rounded-3xl mt-2 px-2 bg-[rgba(255,255,255,0.2)] caret-black shadow-2xl border border-white focus:outline-none active:outline-none"
                type="text"
                id="username"
              />
               */}
          ...
          <div className="flex  w-full px-2 shadow-2xl flex-col mb-4">
            <Input
              value={password}
              size="sm"
