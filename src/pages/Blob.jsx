  ...
  return (
    <div className="flex bg-transparent">
      <motion.section
        ...
        className="flex justify-center opacity-25 pointer-events-none blur-[100px] left-0 top-0 w-[500px] h-[500px] rounded-[100%] fixed z-[-20] items-center"
      >
          ...
          <path fill="#8A3FFC" transform="translate(100 100)">
            <animate
              ...
              values="M54.1,-56.4C66.6,-41.6,70.7,-20.8,70.4,-0.3C70.1,20.1,65.2,40.3,52.8,52.8C40.3,65.2,20.1,70.1,0.4,69.7C-19.3,69.3,-38.6,63.6,-54.7,51.1C-70.8,38.6,-83.7,19.3,-82.4,1.3C-81.2,-16.8,-65.7,-33.5,-49.6,-48.4C-33.5,-63.2,-16.8,-76.1,2,-78.2C20.8,-80.2,41.6,-71.3,54.1,-56.4Z;
                    ...
                    M54.1,-56.4C66.6,-41.6,70.7,-20.8,70.4,-0.3C70.1,20.1,65.2,40.3,52.8,52.8C40.3,65.2,20.1,70.1,0.4,69.7C-19.3,69.3,-38.6,63.6,-54.7,51.1C-70.8,38.6,-83.7,19.3,-82.4,1.3C-81.2,-16.8,-65.7,-33.5,-49.6,-48.4C-33.5,-63.2,-16.8,-76.1,2,-78.2C20.8,-80.2,41.6,-71.3,54.1,-56.4Z"
            ></animate>
          </path>
        </svg>
      </motion.section>
